                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          TutorLmsTextWidget(title: 'First name', style:AppTextStyle.normalTextStyle(FontSize.sp_16, Theme.of(context).shadowColor)),
                                          HorizontalSpacing(width: Dimensions.w_100),
                                          TutorLmsTextWidget(title: 'Last name', style:AppTextStyle.normalTextStyle(FontSize.sp_16, Theme.of(context).shadowColor)),
                                      ...
                                      Padding(
                                        ...
                                        child: TutorLmsTextWidget(
                                            title: "with our them & condication.",
                                            style: AppTextStyle.bodyMediumTextStyle(
                                              color: AppColor.greyColor,
